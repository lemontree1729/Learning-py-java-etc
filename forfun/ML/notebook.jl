...
# ╔═╡ 1e57bb40-8edf-11ec-2fb8-db6fbc227596
using Flux

# ╔═╡ 889e2b25-5cfd-446f-a9fa-c581c6584d5f
buffer = IOBuffer()

# ╔═╡ baf9461d-381f-439c-8483-0d0fdabf7f4e
printAll(buffer) = take!(buffer) |> String |> Text

# ╔═╡ e2bcb95f-454e-4c3f-842e-c53751e953cb
x_train = [[1],[2],[3]]

# ╔═╡ b518bbc8-63d4-4ab7-afcd-797553b9be8e
y_train = [[2],[4],[6]]

# ╔═╡ c0751372-77b9-4dab-8160-f08e0d24ac29
W=0

# ╔═╡ b4a1339b-96ad-4f72-b13e-5712560ab438
b=0

# ╔═╡ bc3fc9ba-348f-456e-9ca3-ce6abb4ce97b
hypothesis(x) = W*x.+ b

# ╔═╡ 68b79b5b-a2a9-4fef-9fd3-9b0dbcc8d459
cost(x, y) = (x.-y).^2

# ╔═╡ 0f8e557f-93d3-492e-b6f8-0eef260cd901
function update()
  η = 0.1 # Learning Rate
  for p in (W, b)
...
# ╔═╡ abba5f58-6998-4ba8-aae8-1f5e2ce1ab7f
nb_epochs = 2000

# ╔═╡ 907fa454-86aa-4202-a660-6dc030afcdce
for epoch in 1:nb_epochs
	update()
	if epoch % 100 == 0
		print(buffer, "Epoch $epoch")
	end
end
