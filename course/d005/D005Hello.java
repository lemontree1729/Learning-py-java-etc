 ...
 * AND THIS IS COMMANT
 */
public class D005Hello { // declare class and class name as "Hello"
	public static int sum(int i, int j) { // declare method, name "sum",output type and input with type
		return i + j; // return int as i + j
	}

	public static void main(String[] args) { // you should declare input String[] (name). else, compiler can't find main
												// function
		int i;
		int j;
		char a;
