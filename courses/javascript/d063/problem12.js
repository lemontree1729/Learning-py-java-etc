...
<div class="product-description"></div>`;
    myproduct.querySelector(".product-img>img").src = product.image_link;
    myproduct.querySelector(".product-name").innerHTML = `${product.name}($${product.price})`;
    myproduct.querySelector(".product-description").innerHTML = product.description;
    return myproduct;
}
