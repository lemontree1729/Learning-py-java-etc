const commentInput = <HTMLInputElement>document.getElementById('user-comment-input')! // 사용자 댓글 입력창
...
const comments: Array<string> = [] // 사용자 댓글목록 배열
const insults = ['shit', 'fuck', 'poo', 'dumb', 'ass']

function buildElement(comment: string) {
...
function displayComments(comments: Array<string>) {
