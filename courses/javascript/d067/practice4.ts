...
const searchEl = <HTMLInputElement>document.getElementById('search')!
...
searchEl.addEventListener("input", () => {
    if (searchEl.value)
        lyricsEl.innerHTML = lyrics.replace(new RegExp(searchEl.value, "g"), `<span class="highlight">${searchEl.value}</span>`)
    else
        lyricsEl.innerHTML = lyrics
})